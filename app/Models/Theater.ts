...
export default class Theater extends BaseModel { //El orm, por debajo toma el diagrama de clases y lo pasa a bases de datos
  ...
  @hasMany(() => Screening,{ 
    foreignKey: 'theater_id' // Este es el nombre de la clave foranea en la de Screening
  })
  public screenings: HasMany<typeof Screening>

  @hasMany(() => Seat,{ 
    foreignKey: 'theater_id' // Este es el nombre de la clave foranea en la de seats
  })
